...
<h1 class="titulo">Televisores</h1>
    <main>
        ...
        <div class="carousel-inner">
            ...
            <img src="imagenes/tv.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="imagenes/tv2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="imagenes/tv3.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <section class="cards">
        ...
        <div class="col">
            <div class="card">
            <img src="imagenes/tv.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">LG 1200</h5>
        ...
        <div class="col">
            ...
            <div class="card-body">
                <h5 class="card-title">Samsung SmarTV</h5>
        ...
        <div class="col">
            ...
            <div class="card-body">
                <h5 class="card-title">Sony xr2</h5>
        ...
        <div class="col">
            <div class="card">
            <img src="imagenes/tv4.avif" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col">
            <div class="card">
            <img src="imagenes/tv5.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col">
            <div class="card">
            <img src="imagenes/tv6.jpeg" class="card-img-top" alt="...">
            <div class="card-body">
